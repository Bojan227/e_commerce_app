...
class CustomTextTheme extends ThemeExtension<CustomTextTheme> {
  ...
  static final textTheme = CustomTextTheme(
      displayLarge: displayTextStyle(48.0, FontWeight.w600),
      displayMedium: displayTextStyle(48.0, FontWeight.w400),
      displaySmall: displayTextStyle(48.0, FontWeight.w300),
      headlineLarge: headlineTextStyle(32.0, FontWeight.w600),
      ...
      bodyLarge: bodyTextStyle(18.0, FontWeight.w500),
      ...
      bodyMedium1: labelTextStyle(16.0, FontWeight.w300),
      bodySmall1: labelTextStyle(16.0, FontWeight.w100),
      bodyLarge2: labelTextStyle(14.0, FontWeight.w500),
      bodyMedium2: labelTextStyle(14.0, FontWeight.w300),
      bodySmall2: labelTextStyle(14.0, FontWeight.w100),
      bodyLarge3: labelTextStyle(12.0, FontWeight.w500),
      bodyMedium3: labelTextStyle(12.0, FontWeight.w300),
      bodySmall3: labelTextStyle(12.0, FontWeight.w100));
}
